  ...
  return (
    <section className="w-full h-full flex items-center flex-col justify-start px-4 sm:px-0">
      <div className="flex h-full   flex-col items-start lg:flex-row w-[100%] justify-center   z-50 text-primary">
        <div className="w-full px-2 sm:p-16 xl:px-72 flex h-full justify-start items-center flex-col ">
          <div
            ref={textRef}
            className="w-full lg:w-full h-full flex flex-col text-sm/8 tracking-wide z-20 gap-4 sm:text-lg/7 lg:text-xl/7 2xl:text-2xl/7 items-start justify-start font-light font-avenir pb-6 prose prose-invert prose-sm max-w-none [&_a]:underline [&_ul]:list-disc [&_ul]:ml-4 [&_ol]:list-decimal [&_ol]:ml-4 [&_li]:ml-2"
          >
            <ReactMarkdown
              components={{
