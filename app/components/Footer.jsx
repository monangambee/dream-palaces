...
export default function Footer({ firstFilmSlug }) {
  ...
  if (pathname === '/') {
    return (
      <footer className="w-full min-h-[10vh] flex z-20 items-center justify-center font-frontage bg-background border-t-[0.5px] border-primary text-primary p-2 text-[10px] sm:text-xs">
